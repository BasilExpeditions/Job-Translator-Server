$( document ).ready(function() {
    ...
    $("#translateButton").click( async (event) => {
      ...
      // Scroll animation onClick translate button
      $("html, body").animate({
      ...
      const keys = Object.keys(result);
        ...
        keys.map((x, index) => {
          ...
          if(jobDescription.includes(x)) {
            ...
            $('#results ul').append(`<li class="liText" style='text-decoration: none; padding-top: 1em;'><strong>${x}</strong> &rarr; ${values[index]}</li>`)
          }
        }
      )
    ...
    console.log('The first name is a route, attempt your answer with:')
    console.log('https://job-translator.herokuapp.com/?????')
